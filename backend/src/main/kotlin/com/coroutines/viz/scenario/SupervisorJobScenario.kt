...
class SupervisorJobScenario : Scenario {
    ...
    override fun buildTimeline(): EventTimeline {
        ...
        val events = listOf(
            ...
            NarrativeEvent(1300, "Exception from launch #2 goes to the CoroutineExceptionHandler (uncaught handler) — it is NOT propagated to the supervisor"),
            NarrativeEvent(1400, "SupervisorJob does not see the failure — siblings keep running"),
...
suspend fun main() = supervisorScope {
    ...
    private fun buildBeginnerTimeline(): EventTimeline {
        ...
        val events = listOf(
            ...
            NarrativeEvent(1300, "Exception from launch #1 goes to the CoroutineExceptionHandler — it is NOT propagated to the supervisor"),
            NarrativeEvent(1400, "SupervisorJob does not see the failure — child #2 keeps running"),
...
suspend fun main() = supervisorScope {
    ...
    private fun buildAdvancedTimeline(): EventTimeline {
        ...
        val events = listOf(
            ...
            NarrativeEvent(1500, "Exception from launch #2 goes to the CoroutineExceptionHandler — it is NOT propagated to the supervisor"),
            NarrativeEvent(1600, "SupervisorJob does not see the failure — siblings and their children are NOT affected"),
